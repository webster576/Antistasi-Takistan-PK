...
private _loadText = format [localize "$STR_antistasi_load_crate_to_vehicle", getText (configFile >> "CfgVehicles" >> typeOf _object >> "displayName")];
...
switch (_action) do {
    ...
    case "unload": {
        private _text = localize "$STR_antistasi_unload_cargo";
