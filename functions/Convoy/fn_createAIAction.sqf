  ...
  if(_sideCheck == _side) then
  {
    ...
    if(!_abort && !(_origin isEqualTo "")) then
    {
      ...
      switch (_selectedType) do
      {
      	case "Ammunition":
      	{
      		_text = format [localize "$STR_antistasi_ammo_convoy_desc",_nameOrigin,_displayTime,_nameDest];
      	...
      	case "Armor":
      	{
      		_text = format [localize "$STR_antistasi_armored_convoy_desc",_nameOrigin,_displayTime,_nameDest];
      	...
      	case "Prisoners":
      	{
      		_text = format [localize "$STR_antistasi_prisoners_convoy_desc",_nameOrigin,_displayTime,_nameDest];
      	...
      	case "Reinforcements":
      	{
      		_text = format [localize "$STR_antistasi_reinforcements_convoy_desc",_nameOrigin,_displayTime,_nameDest];
      	...
      	case "Money":
      	{
      		_text = format [localize "$STR_antistasi_money_convoy_desc",_nameOrigin,_displayTime,_nameDest];
      	...
      	case "Supplies":
      	{
      		_text = format [localize "$STR_antistasi_supply_convoy_desc",_nameOrigin,_displayTime,_nameDest,nameTeamPlayer];
