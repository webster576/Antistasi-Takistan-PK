...
[[teamPlayer,civilian],_taskId,[format [localize "$STR_antistasi_ammotruck_task_desc",_nameDest,_displayTime],localize "$STR_antistasi_ammotruck_task_title",_markerX],_pos,false,0,true,"rearm",true] call BIS_fnc_taskCreate;
