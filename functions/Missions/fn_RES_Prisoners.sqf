...
[[teamPlayer,civilian],_taskId,[format [localize "$STR_antistasi_pow_rescue_task_desc",_nameDest,_displayTime],localize "$STR_antistasi_pow_rescue_task_title",_markerX],_positionX,false,0,true,"run",true] call BIS_fnc_taskCreate;
