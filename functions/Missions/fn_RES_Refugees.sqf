...
[[teamPlayer,civilian],_taskId,[_textX,localize "$STR_antistasi_refugees_evac_task_title",_nameDest],_posTsk,false,0,true,"run",true] call BIS_fnc_taskCreate;
