...
if ((_allUnlockedArray findIf {!_x} isEqualTo -1)) then {
    ["Loot crate", localize "$STR_antistasi_loot_transfered_to_crate"] call A3A_fnc_customHint;
} else {
    ["Loot crate", localize "$STR_antistasi_unable_transfer_loot_to_crate"] call A3A_fnc_customHint;
};
